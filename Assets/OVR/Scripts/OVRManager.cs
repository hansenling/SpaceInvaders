...
#region Unity Messages
	...
	{
		print ("X:");
		print (OVRManager.capiHmd.GetTrackingState().HeadPose.ThePose.Position.x);
		print ("Y:");
		print (OVRManager.capiHmd.GetTrackingState().HeadPose.ThePose.Position.y);
		print ("Z:");
		print (OVRManager.capiHmd.GetTrackingState().HeadPose.ThePose.Position.z);
